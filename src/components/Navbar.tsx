        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              ...
              className="px-4 py-2 rounded-xl text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 hover:text-blue-700 border border-slate-200 transition-all duration-200 cursor-pointer shadow-2xs"
            >
              Build My Website
            </a>
          ...
          <div className="lg:hidden mt-3 p-4 bg-white/95 backdrop-blur-2xl rounded-2xl border border-slate-200 shadow-xl flex flex-col gap-3 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="pt-2 border-t border-slate-200 flex flex-col gap-2">
              <a
                ...
                className="w-full py-2.5 rounded-xl text-xs font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 text-center flex items-center justify-center gap-1.5"
              >
